...
* sample data generated by the script looks like this. ( for search query: "oil and gas price")
  ...
  ![alt text](https://github.com/magnimel/sir-ml-project/blob/master/google_news_data_cleaned.png)
...
(sentiment_analysis_result.csv)
  ![alt text](https://github.com/magnimel/sir-ml-project/blob/master/sentiment_analysis_result.png)

(result_stats.csv)
    ![alt text](https://github.com/magnimel/sir-ml-project/blob/master/result_stats.png)
